...
public class Knight_StrokeHit : MonoBehaviour
{
    public static float m_CoolTime;
    public static float m_Timer;
    public float m_ReqMp = 2.0f;
    ...
    public void StrokeHit()
    {
        ...
        m_Player.m_KnightStrokeHit = true;

        if (m_Player.m_KnightStrokeHitObj != null)
            m_Player.m_KnightStrokeHitObj.SetActive(true);
    }
}
